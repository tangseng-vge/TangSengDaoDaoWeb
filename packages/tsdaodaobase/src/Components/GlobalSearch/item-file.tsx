    ...
    return (
      ...
      >
        ...
        <div className="wk-item-file-desc">
          <div className="wk-item-file-sender">{this.props.sender}</div>
          <div className="wk-item-file-line" />
          <div className="wk-item-file-recv">{channel.channel_name}</div>
          <div className="wk-item-file-line" />
          <div className="wk-item-file-size">
            {FileHelper.getFileSizeFormat(file.size || 0)}
          </div>
          <div className="wk-item-file-line" />
          <div className="wk-item-file-time">
