    ...
    return (
      <div className="wk-sections">
        {sections.map((section, i) => {
          return (
            <div key={i} className="wk-section">
              {section.title && section.title !== "" ? (
                <div className="wk-section-title">{section.title}</div>
              ) : undefined}

              <div className="wk-channelsetting-section-rows">
                {section.rows?.map((row, j) => {
                  return (
                    <div key={j} className="wk-section-row">
              ...
              {section.subtitle && section.subtitle !== "" ? (
                <div className="wk-section-subtitle">{section.subtitle}</div>
              ) : undefined}
            </div>
          );
        })}
