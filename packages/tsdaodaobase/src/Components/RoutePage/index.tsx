  ...
  implements RouteContext<any>, FinishButtonContext
{
  ...
  render() {
    ...
    return (
      <div className="wk-route">
        <div className="wk-route-header">
          <div
            className="wk-route-header-close"
            onClick={() => {
              if (pushViewCount > 0) {
                this.pop();
                return;
          ...
          >
            <div
              className={classNames(
                ...
                pushViewCount > 0 ? "wk-state-back" : undefined
              )}
            ></div>
          </div>
          <div
            className={classNames(
              ...
              pushViewCount > 0 ? "wk-route-header-title-box-open" : undefined
            )}
          >
            <div className="wk-route-header-title">{title}</div>
          ...
          <div
            className={classNames(
              ...
              pushViewCount > 0 ? "wk-route-header-right-view-open" : undefined
            )}
          >
