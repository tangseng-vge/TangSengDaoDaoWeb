    ...
    return (
      <Provider
        ...
        render={(vm: ChannelQRCodeVM) => {
          return (
            <div className="wk-channelqrcode">
              <div className="wk-channelqrcode-box">
                ...
                <div className="wk-channelqrcode-qrcode-box">
                  {channelInfo?.orgData?.invite === 1 && vm.qrcodeResp ? (
                    <div className="wk-channelqrcode-qrcode-mask">
                      <p>该群已开启进群验证</p>
                      <p>只可通过邀请进群</p>
                    </div>
                  ) : undefined}
                  ...
                  <div className="wk-channelqrcode-qrcode">
                    {vm.qrcodeResp ? undefined : (
                      <div className="wk-channelqrcode-qrcode-loading">
                        <Spin></Spin>
                      </div>
                    )}
                    {vm.qrcodeResp ? (
                  ...
                  {vm.qrcodeResp ? (
                    <div className="wk-channelqrcode-expire">
