...
export default class SmallTableEdit extends Component<SmallTableEditProps> {
  render(): ReactNode {
    ...
    return (
      <div className="wk-smalltableedit">
        <div className="wk-smalltableedit-content">
          <div className="wk-smalltableedit-content-items">
            {items.map((item) => {
              return (
                <div className="wk-smalltableedit-content-item" key={item.id}>
                  ...
                  {item.showAction ? (
                    <div
                      className="wk-smalltableedit-content-item-action"
                      onClick={() => {
                        if (item.onAction) {
                          item.onAction();
                        }
          ...
          <div
            className="wk-smalltableedit-content-item"
