      ...
      <MessageBase hiddeBubble={true} message={message} context={context}>
        ...
        >
          <div className="wk-message-location-content">
            <div className="wk-message-location-content-title">
              {content.title}
            </div>
            <div className="wk-message-location-content-address">
              {content.address}
            </div>
            <div
              className="wk-message-location-content-locationimg"
              style={{
